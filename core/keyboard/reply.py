...
], resize_keyboard=True, one_time_keyboard=False, input_field_placeholder="Отправить геолокацию, контанкт, викторина")
...
def get_reply_keyboard():
    ...
    keyboard_builder.button(text='Создать опрос', request_poll=KeyboardButtonPollType())
    keyboard_builder.adjust(3,2,1)
    return keyboard_builder.as_markup(resize_keyboard=True, one_time_keyboard=True, input_field_placeholder='Отправить геолокацию, контанкт, викторина')
